...
-   Bar graph
    ...
    -   used to show distribution data
    -   The following shows the total number of deposits made for each month
...
sum_deposits_per_month$deposit <- as.integer(sum_deposits_per_month$deposit)
